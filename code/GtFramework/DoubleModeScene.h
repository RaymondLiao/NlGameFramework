...
private:
	int m_level;
	int m_stickCount, m_baseStickCount;
	bool m_playerATurn;
	bool m_isPlayerALose;

	Ground* m_ground;
	Basket *m_basketA, *m_basketB;
	NlCloth *m_basketClothA, *m_basketClothB;
	...
	// score information
	NlGUITexture *m_scoreGraphA, *m_scoreGraphB;
	NlGUIText *m_loseA, *m_loseB;
